...
const Dashboard = () => {
  return (
    <div className="flex flex-col">
      ...
      <div className="main mt-3 flex flex-col md:flex-row gap-3">
        <div className="first-column flex flex-col gap-19 w-65">
          <div className="p-5 hidden md:display md:flex flex-col gap-5 border-[15px] border-white rounded-md mb-4 ">
          ...
          {/* <div className="nav"> */}
          <div className="activity-container hidden md:display  md:flex flex-col bg-white border-[12px] rounded-md border-white ">
          ...
          {/* forums */}
          <div className="forums-container hidden md:display  md:flex flex-col bg-white border-[12px] mt-5 border-white rounded-md">
            <div className="flex gap-2 justify-between w-full items-center mb-3">
              <div className="flex gap-3 items-center">
                <span className="material-symbols-outlined   text-blue-800">
                  forum
        ...
        <div className="second-column flex flex-col md:w-[65%] gap-3">
          <div className="md:flex hidden">
            <Carousel />
          </div>
          <div className="image-container w-min-[400px] md:w-[730px] h-[150px] rounded-md">
            <img
          ...
          {/* moblie carousel */}
          <div className="flex md:hidden display">
            <Carousel />
          </div>

          <div className="blog-post-container flex items-center justify-center flex-col md:w-[730px]  rounded-[15px]  bg-white bg-[100px] pt-3">
            <div className="input-field w-[90%] flex items-center justify-center gap-3 ">
              <div className="image ">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTgD14vQ6I-UBiHTcwxZYnpSfLFJ2fclwS2A&s"
                  alt="profile"
                  className="w-[50px] h-[50px] rounded-full  border-[2px] border-red-700"
                />
              </div>
              <div className="input flex items-center justify-start bg-[#e0e0e0]">
                <input
                  type="text"
                  placeholder="Whats on your mind?"
                  className="rounded-md md:w-[450px] w-[100%] bg-[#e0e0e0] "
                />
              </div>
              <div className="btn btn-primary">
                <button className=" font-semibold text-[13px] w-[50px]">
                  Share Post
                </button>
              </div>
            </div>
            <div className="attachements flex gap-5 mx-5 mt-5 mb-2">
              ...
              <div className="image flex gap-2 items-center cursor-pointer">
                Mention
              </div>
            </div>
          </div>
          <div className="blog-feed m-1 bg-white p-3 rounded-[20px] ">
            <div className="blog-containerp-4 h-[380px] md:w-[700px] md:h-[500px]  flex flex-col gap-[16px] justify-center">
              <div className="blog-top flex gap-[10px] ml-3">
                <div className="image">
                  <img
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTgD14vQ6I-UBiHTcwxZYnpSfLFJ2fclwS2A&s"
                    alt=""
              ...
              <div className="flex items-center justify-center">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTgD14vQ6I-UBiHTcwxZYnpSfLFJ2fclwS2A&s"
                  alt="post img"
                  className="w-[550px] h-[250px] md:w-[600px] md:h-[350px] rounded-md"
                />
              </div>
              <div className="blog-extra flex gap-[50px] ml-5">
        ...
        {/* msg */}
        <div className="third-column w-[300px] hidden md:flex h-[550px] bg-white rounded-[15px] border-[4px] flex-col p-1 ">
            ...
            <div className="names flex flex-col">
              <div className="headings flex justify-between w-full mb-3">
                <div className="left flex text-[16px] gap-6">
                  <div className="text-[13px] font-bold border-b-2 border-black cursor-pointer ">
                    Primary
                  </div>
      ...
      {/* footer code */}
      <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content items-center p-4 mt-3">
