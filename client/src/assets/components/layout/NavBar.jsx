    ...
    <div className="navbar bg-base-100 w-[95%] mx-auto rounded-md shadow-md grid grid-cols-2 lg:grid-cols-4 auto-cols-max relative">
      ...
      <div className="navbar-start w-[unset] lg:col-span-1">
        ...
        <div className="dropdown static">
          ...
          >
            <li>
              <NavLink to="/dashboard" className="py-4 flex items-center">
            ...
            <li>
              <NavLink to="" className="py-4 flex items-center">
                <span className="text-2xl text-primary">
                  <HiNewspaper />
                </span>
                Blogs
            ...
            <li>
              <NavLink to="/network" className="py-4 flex items-center">
                <span className="text-2xl text-primary">
                  <IoMdPeople />
                </span>
                Network
        ...
        {/* DevConnect Link */}
        <Link to="/" className="btn btn-ghost text-xl rounded-md">
          DevConnect
        </Link>
      </div>
      ...
      <div className="navbar-center hidden lg:flex w-[unset] justify-center lg:col-span-2">
        <ul className="menu menu-horizontal px-1">
          ...
          <li>
            <NavLink to="/network" className="flex items-center">
              <span className="text-2xl text-primary">
                <IoMdPeople />
              </span>
              Network
      ...
      <div className="navbar-end flex-none md:gap-2 w-[unset] lg:col-span-1">
        ...
        <div className="dropdown dropdown-end">
          ...
          >
            ...
            <li>
              <NavLink to={profileURL} className="py-4 flex items-center">
                <span className="text-2xl text-primary">
                  <FaUserCircle />
                </span>
                Profile
            ...
            <li>
              <button onClick={handleLogout} className="py-4 flex items-center">
                <span className="text-2xl text-primary">
                  <RiLogoutBoxLine />
                </span>
                Logout
